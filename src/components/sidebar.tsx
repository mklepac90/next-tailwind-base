...
const Sidebar = () => {
  ...
  <nav
    ...
    className="w-60 -translate-x-full overflow-hidden bg-white shadow-md dark:bg-zinc-800 md:data-[te-sidenav-hidden='false']:translate-x-0"
      ...
      <ul
        ...
        <li className="relative">
          <a
            ...
            <span
              className="mr-4 [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:fill-gray-700 dark:[&>svg]:fill-gray-300">
              <svg
        ...
        <li className="relative">
          <a
            ...
            data-te-sidenav-link-ref>
            <span
              className="mr-4 [&>svg]:h-4 [&>svg]:w-4 [&>svg]:fill-gray-700 dark:[&>svg]:fill-gray-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512">
                {/* <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
        ...
        <li className="relative">
          <a
            ...
            <span
              className="absolute right-0 ml-auto mr-[0.8rem] transition-all duration-300 ease-linear motion-reduce:transition-none [&>svg]:h-3 [&>svg]:w-3 [&>svg]:fill-gray-600 dark:[&>svg]:fill-gray-300"
              data-te-sidenav-rotate-icon-ref>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512">
